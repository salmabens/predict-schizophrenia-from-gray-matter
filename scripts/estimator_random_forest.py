...
class ROIsFeatureExtractor(BaseEstimator, TransformerMixin):
 ...
 'rTemTraGy_CSF_Vol'])
    ...
    (autre_GM, autre_CSF, "autre")
        ...
        return np.array(train_rois[["lPal_GM_Vol",
                                     "rPal_GM_Vol",
                                     "rCenOpe_CSF_Vol",
                                     "lInfFroOrbGy_CSF_Vol",
                                     "rPla_CSF_Vol",
...
def get_estimator():
    ...
    estimator = make_pipeline(
        ...
        MinMaxScaler(),
        RandomForestClassifier(n_estimators=77, max_depth=17, min_samples_split=9, min_samples_leaf=4, max_features='sqrt', bootstrap=False, random_state=42)
    )
    return estimator
