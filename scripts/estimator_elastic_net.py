...
class ROIsFeatureExtractor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        X = X[:, :284]
        train_rois = pd.DataFrame(X, columns=['l3thVen_GM_Vol',
 'r3thVen_GM_Vol',
 'l4thVen_GM_Vol',
 'r4thVen_GM_Vol',
 'lAcc_GM_Vol',
 ...
 'rTemTraGy_CSF_Vol'])
    ...
    (autre_GM, autre_CSF, "autre")
        ...
        return np.array(train_rois[["Vol_CSF_cortex_cerebral", 
                                    "Vol_GM_cortex_cerebral", 
                                    "CSF_Vol", 
                                    "GM_Vol", 
                                    "Vol_GM_structures_sous_corticales", 
                                    "WM_Vol", 
                                    "Vol_CSF_cervelet", 
                                    "Vol_CSF_tronc_cerebral", 
                                    "Vol_GM_cervelet", 
                                    "Vol_GM_autre", 
                                    "rSupParLo_CSF_Vol", 
                                    "rSupFroGy_CSF_Vol", 
                                    "lSupFroGy_CSF_Vol", 
                                    "lSupParLo_CSF_Vol", 
                                    "Vol_CSF_structures_sous_corticales", 
                                    "rExtCbe_CSF_Vol", 
                                    "lPoCGy_CSF_Vol", 
                                    "rPoCGy_CSF_Vol", 
                                    "lExtCbe_CSF_Vol", 
...
def get_estimator():
    ...
    estimator = make_pipeline(
        ...
        MinMaxScaler(),
        LogisticRegression(penalty='elasticnet', solver='saga', C=0.09360659956296145, max_iter=2533, l1_ratio=0.44939891537109655, random_state=42)
    )
    return estimator
