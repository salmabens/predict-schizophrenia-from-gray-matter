...
class ROIsFeatureExtractor(BaseEstimator, TransformerMixin):
 ...
 'rTemTraGy_CSF_Vol'])
    ...
    (autre_GM, autre_CSF, "autre")
        ...
        return np.array(train_rois[['rPal_GM_Vol', 
                                    'lAntIns_CSF_Vol', 
                                    'lPal_GM_Vol', 
                                    'rPla_CSF_Vol', 
                                    'lMedFroCbr_CSF_Vol', 
...
def get_estimator():
    ...
    estimator = make_pipeline(
        ...
        MinMaxScaler(),
        GradientBoostingClassifier(n_estimators=56, learning_rate=4.450851078458098e-05, max_depth=4, subsample=0.6922360672727326, min_samples_split=15, min_samples_leaf=8, max_features=0.4093597867018952, random_state=42)
    )
    return estimator
